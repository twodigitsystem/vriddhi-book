...
export default function UtilitiesPage() {
  ...
  return (
    <div className="container max-w-7xl p-6">
      ...
      <Tabs defaultValue="import-export" className="space-y-6">
        ...
        <TabsContent value="generators" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => openDialog("barcode")}>
              <CardHeader>
                <div className="flex items-center gap-2">
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => openDialog("qr")}>
              <CardHeader>
                <div className="flex items-center gap-2">
        ...
        <TabsContent value="system" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => openDialog("health")}>
              <CardHeader>
                <div className="flex items-center gap-2">
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => openDialog("backup")}>
              <CardHeader>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-amber-800 dark:text-amber-200">
                    Some operations may require putting your application in maintenance
                    mode. Always create a backup before performing bulk operations.
                  </p>
                </div>
              </div>
            </CardContent>
      ...
      {/* Dialogs */}
      <BarcodeGenerator
        isOpen={activeDialog === "barcode"}
        onClose={closeDialog}
      />
      <QRGenerator isOpen={activeDialog === "qr"} onClose={closeDialog} />
      <DatabaseHealthDialog
        isOpen={activeDialog === "health"}
        onClose={closeDialog}
      />
      <BackupManagerDialog
